...
(function (game) {
        ...
        GamePage: {
            ...
            childs: [
                ...
                [UI[2], { textStyle: "gameHead" }, , , , , , "100%", 70, , , , , , , , , , , , , [
                        ...
                        [UI[7], , "sound", 630, 8, , , 56, , , , , , , , , , , , { icon: { src: RES[7] }, checkImg: { src: RES[8] } }],
                    ]],
            ]
        },
    };
    ...
    var ResultPage = (function (_super) {
        ...
        ResultPage._childs = [
            [UI[4], { src: RES[12] }, , 198, 77, , , 336, 322],
            ...
            [UI[4], { src: RES[13] }, , 177, 503, , , 360, 2],
            [UI[4], { src: RES[13] }, , 177, 579, , , 360, 2],
    ...
    var SharePage = (function (_super) {
        ...
        SharePage._childs = [
            [UI[3], { gradient: { y1: 1280, colors: ['#010036', '#4e004f'] } }, "bg", , , , , "100%", "100%"],
            [UI[4], { src: RES[14] }, , 64, 92, , , 323, 46],
            [UI[4], { src: RES[15] }, , 81, 300, , , 522, 231],
            [UI[6], { text: "姓名：" }, "name", 114, 337, , , 383, 37],
            [UI[6], { text: "成绩：10000" }, "score", 114, 387, , , 383, 37],
            [UI[6], , "info", 114, 439, , , 383, 37],
            [UI[5], { label: "关闭", style: "blue" }, "closeRank", , 669, , , 195, 70, "50%"],
            [UI[4], { src: RES[16] }, , 65, 165],
    ...
    var _RankItem = (function (_super) {
        ...
        _RankItem._childs = [
            ...
            [UI[4], { src: RES[19] }, "rankIcon", 27, 15, , , 44, 48]
        ];
        return _RankItem;
    }(ui.Container));
    ...
    var RankPage = (function (_super) {
        ...
        RankPage._childs = [
            [UI[4], { src: RES[20] }, , 0, 0, , , 640, 1300],
            [UI[4], { src: RES[21] }, , 45, 219, , , 540, 806],
            [UI[5], , "closeRank", 566, 200, , , 39, 38, , , , , , , , , , , { bk: { src: RES[22] } }],
        ...
        _StartPage._childs = [
            ...
            [UI[2], , "mainPage", , , , , "100%", "100%", , , , , , , , , , , , , [
                    [UI[0], , "stage", , , , , "100%", 1280, , "50%", , , , , , , , , , , [
                            { type: "Image", id: "蝙蝠侠", src: RES[24], x: 515, y: 812, anchorX: 0.5, anchorY: 0.5 },
                            { type: "Image", id: "猪", src: RES[25], x: 38, y: 112 },
                            { type: "Image", src: RES[26], x: 132, y: 538 },
                            { type: "Image", src: RES[27], x: 103, y: 402 },
                        ]],
                    [UI[4], { src: RES[28] }, , , , , "10%", 237, 34, "50%"],
                    [UI[5], , "help", 80, , , "15%", 218, 85, , , , , , , , , , , { bk: { src: RES[29] } }],
                    [UI[5], , "start", , , 80, "15%", 218, 85, , , , , , , , , , , { bk: { src: RES[30] } }],
...
(function (game) {
    ...
    function startGame(stage, n, gameOver) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var enemies, getMask, enemiesData, i, hole1, hole, circle, lastPos, chance, launch, r, dx, dy, i, e, data, dx1, dy1, score_1, s, arr, j, idx, i, line, r_1, hx, hy, dr, i, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        enemies = [];
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    console.log("线下");
                    return [4, ez.loadJSONPackageAsync("assets/resource.json", "assets/res/")];
                case 2:
                    _a.sent();
                    ez.loadGroup(["ui", "start", "image/bg"], function (progress, total) {
                        if (progress >= total) {
