namespace game{
		...
		GamePage:{
			...
			childs:[
				...
				[/*Group*/UI[2], /*props:*/ {textStyle: "gameHead"},,,,,, /*width:*/ "100%", /*height:*/ 70,,,,,,,,,,,,,/*childs*/ [
					...
					[/*game.Checkbox*/UI[7],, /*id:*/ "sound", /*left:*/ 630, /*top:*/ 8,,, /*width:*/ 56,,,,,,,,,,,, /*childsProperty*/{icon: { src: /*ui/btn/喇叭*/ RES[7] }, checkImg: { src: /*ui/btn/喇叭check*/ RES[8] }}],
				]],
			]
		},
	}
	...
	export class ResultPage extends ui.Container {
		...
		private static _childs = [
			[/*Image*/UI[4], /*props:*/ {src: /*ui/img/奖杯*/ RES[12]},, /*left:*/ 198, /*top:*/ 77,,, /*width:*/ 336, /*height:*/ 322],
			...
			[/*Image*/UI[4], /*props:*/ {src: /*ui/img/line*/ RES[13]},, /*left:*/ 177, /*top:*/ 503,,, /*width:*/ 360, /*height:*/ 2],
			[/*Image*/UI[4], /*props:*/ {src: /*ui/img/line*/ RES[13]},, /*left:*/ 177, /*top:*/ 579,,, /*width:*/ 360, /*height:*/ 2],
	...
	export class SharePage extends ui.Container {
		...
		private static _childs = [
			[/*RectFill*/UI[3], /*props:*/ {gradient: { y1: 1280, colors:['#010036', '#4e004f'] }}, /*id:*/ "bg",,,,, /*width:*/ "100%", /*height:*/ "100%"],
			[/*Image*/UI[4], /*props:*/ {src: /*share/logo*/ RES[14]},, /*left:*/ 64, /*top:*/ 92,,, /*width:*/ 323, /*height:*/ 46],
			[/*Image*/UI[4], /*props:*/ {src: /*share/rect*/ RES[15]},, /*left:*/ 81, /*top:*/ 300,,, /*width:*/ 522, /*height:*/ 231],
			...
			[/*game.Button*/UI[5], /*props:*/ {label: "关闭", style: "blue"}, /*id:*/ "closeRank",, /*top:*/ 669,,, /*width:*/ 195, /*height:*/ 70, /*x:*/ "50%"],
			[/*Image*/UI[4], /*props:*/ {src: /*share/text猪望仔大战蝙蝠侠*/ RES[16]},, /*left:*/ 65, /*top:*/ 165],
			...
			[/*Group*/UI[2],,,, /*top:*/ 700,, /*bottom:*/ 0, /*width:*/ 300,, /*x:*/ "50%",,,,,,,,,,,,/*childs*/ [
				[/*Group*/UI[2],,,,,,, /*width:*/ 300, /*height:*/ 332,, /*y:*/ "50%",,,,,,,,,,,/*childs*/ [
					[/*Image*/UI[4], /*props:*/ {src: /*share/二维码*/ RES[17]}, /*id:*/ "share",,,,, /*width:*/ 300, /*height:*/ 332],
				]],
			]]
		];
		constructor(parent: ui.Container, template?:ui.Template){
	...
	export class Splash extends ui.Container {
		...
		private static _childs = [
			[/*Image*/UI[4], /*props:*/ {src: /*logo*/ RES[18]},,,,,,,, /*x:*/ "50%", /*y:*/ "50%"]
		];
		constructor(parent: ui.Container, template?:ui.Template){
			super(parent);
			if(template){
	...
	export class _RankItem extends ui.Container {
		...
		private static _childs = [
			...
			[/*Image*/UI[4], /*props:*/ {src: /*ui/icon/1st*/ RES[19]}, /*id:*/ "rankIcon", /*left:*/ 27, /*top:*/ 15,,, /*width:*/ 44, /*height:*/ 48]
		];
		constructor(parent: ui.Container, template?:ui.Template){
			super(parent);
			if(template){
	...
	export class RankPage extends ui.Container {
		...
		private static _childs = [
			[/*Image*/UI[4], /*props:*/ {src: /*ui/img/rectbk*/ RES[20]},, /*left:*/ 0, /*top:*/ 0,,, /*width:*/ 640, /*height:*/ 1300],
			[/*Image*/UI[4], /*props:*/ {src: /*ui/img/rectwh*/ RES[21]},, /*left:*/ 45, /*top:*/ 219,,, /*width:*/ 540, /*height:*/ 806],
			[/*game.Button*/UI[5],, /*id:*/ "closeRank", /*left:*/ 566, /*top:*/ 200,,, /*width:*/ 39, /*height:*/ 38,,,,,,,,,,, /*childsProperty*/{bk: { src: /*ui/btn/close*/ RES[22] }}],
			...
			[/*Image*/UI[4], /*props:*/ {src: /*ui/icon/cup*/ RES[23]},, /*left:*/ 187, /*top:*/ 246,,, /*width:*/ 44, /*height:*/ 49],
		...
		private static _childs = [
			...
			[/*Group*/UI[2],, /*id:*/ "mainPage",,,,, /*width:*/ "100%", /*height:*/ "100%",,,,,,,,,,,,,/*childs*/ [
				[/*UIStage*/UI[0],, /*id:*/ "stage",,,,, /*width:*/ "100%", /*height:*/ 1280,, /*y:*/ "50%",,,,,,,,,,,/*childs*/ [
					{ type: "Image", id:"蝙蝠侠", src:/*start/蝙蝠侠*/ RES[24], x:515, y:812, anchorX:0.5, anchorY:0.5 },
					{ type: "Image", id:"猪", src:/*start/猪*/ RES[25], x:38, y:112 },
					{ type: "Image", src:/*start/txt蝙蝠侠*/ RES[26], x:132, y:538 },
					{ type: "Image", src:/*start/txt猪望仔*/ RES[27], x:103, y:402 },
				]],
				[/*Image*/UI[4], /*props:*/ {src: /*start/logo*/ RES[28]},,,,, /*bottom:*/ "10%", /*width:*/ 237, /*height:*/ 34, /*x:*/ "50%"],
				[/*game.Button*/UI[5],, /*id:*/ "help", /*left:*/ 80,,, /*bottom:*/ "15%", /*width:*/ 218, /*height:*/ 85,,,,,,,,,,, /*childsProperty*/{bk: { src: /*start/活动规则*/ RES[29] }}],
				[/*game.Button*/UI[5],, /*id:*/ "start",,, /*right:*/ 80, /*bottom:*/ "15%", /*width:*/ 218, /*height:*/ 85,,,,,,,,,,, /*childsProperty*/{bk: { src: /*start/开始游戏*/ RES[30] }}],
